      ...
      `<option value="${p.id}">${p.name}</option>`
	    ...
	    select.addEventListener('change', () => {
	      ...
	      const guides = {
	        ...
	        bluesky: '🦋 <b>To connect Bluesky:</b><br>1. Create a Bluesky account (free)<br>2. Go to Settings → App Passwords<br>3. Create an App Password for ReMentally<br>4. Enter your <b>handle</b> (e.g. user.bsky.social) and the <b>App Password</b>',
	      };
	      if (guideEl) {
