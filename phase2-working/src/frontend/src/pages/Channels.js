    ...
    select.innerHTML = '<option value="">Select a platform…</option>' + platforms.map((p) =>
      `<option value="${esc(p.id)}">${esc(p.name)}</option>`
	    ...
	    select.addEventListener('change', () => {
	      ...
	      // Show setup guide
	      const guides = {
	        telegram: '<span class="material-symbols-rounded" style="font-size:14px;vertical-align:middle;">smart_toy</span> <b>To get your bot token:</b><br>1. Open <a href="https://t.me/botfather" target="_blank" style="color:var(--md-sys-color-primary);">@BotFather</a> on Telegram<br>2. Send <code>/newbot</code> and follow prompts<br>3. Copy the <b>bot token</b> (looks like <code>123456:ABC-DEF1234ghIkl</code>)<br>4. Enter your Telegram <b>user ID</b> as Chat ID (get it from <a href="https://t.me/userinfobot" target="_blank" style="color:var(--md-sys-color-primary);">@userinfobot</a>)',
	        slack: '<span class="material-symbols-rounded" style="font-size:14px;vertical-align:middle;">forum</span> <b>To connect Slack:</b><br>1. Go to <a href="https://api.slack.com/apps" target="_blank" style="color:var(--md-sys-color-primary);">api.slack.com/apps</a><br>2. Create an app or use an existing one<br>3. Under OAuth & Permissions, add <b>chat:write</b> and <b>im:write</b> scopes<br>4. Install to workspace and copy the <b>Bot Token</b> (starts with <code>xoxb-</code>)<br>5. For Channel ID: right-click a channel → "Copy link" → use the ID after <code>/archives/</code>',
	        discord: '<span class="material-symbols-rounded" style="font-size:14px;vertical-align:middle;">videogame_asset</span> <b>To set up Discord:</b><br>1. Go to <a href="https://discord.com/developers/applications" target="_blank" style="color:var(--md-sys-color-primary);">Discord Developer Portal</a><br>2. Create an application → Bot → Copy <b>bot token</b><br>3. Enable <b>Message Content Intent</b> under Bot settings<br>4. Use OAuth2 URL Generator to invite the bot to your server<br>5. Channel ID: right-click channel → Copy ID (enable Developer Mode)',
	        whatsapp: '<span class="material-symbols-rounded" style="font-size:14px;vertical-align:middle;">phone_iphone</span> <b>WhatsApp requires a Meta Business Account:</b><br>1. Go to <a href="https://business.facebook.com" target="_blank" style="color:var(--md-sys-color-primary);">Meta Business Suite</a><br>2. Create a WhatsApp Business Account (free)<br>3. Get your <b>Phone Number ID</b> and <b>API Key</b> from the App Dashboard<br>4. Configure webhook URL: <code>https://yourdomain.com/api/webhooks/whatsapp</code>',
	        ...
	        sms: '<span class="material-symbols-rounded" style="font-size:14px;vertical-align:middle;">sms</span> <b>For SMS (Twilio):</b><br>1. Sign up at <a href="https://twilio.com" target="_blank" style="color:var(--md-sys-color-primary);">Twilio</a> (free credits included)<br>2. Get a phone number with SMS capability<br>3. API Key format: <code>ACCOUNT_SID:AUTH_TOKEN</code><br>4. Phone number with country code, e.g. <code>+15551234567</code>',
	        signal: '<span class="material-symbols-rounded" style="font-size:14px;vertical-align:middle;">lock</span> <b>Signal requires a self-hosted gateway:</b><br>1. Install <a href="https://github.com/AsamK/signal-cli" target="_blank" style="color:var(--md-sys-color-primary);">signal-cli</a> on a server<br>2. Register your phone number with <code>signal-cli register</code><br>3. Set up the REST API wrapper or use a cloud gateway<br>4. Enter your phone number with country code',
        twitter: '<span class="material-symbols-rounded" style="font-size:14px;vertical-align:middle;">tag</span> <b>To connect Twitter/X:</b><br>1. Go to <a href="https://developer.twitter.com" target="_blank" style="color:var(--md-sys-color-primary);">developer.twitter.com</a><br>2. Create a Project → App → Generate <b>API Key</b> + <b>API Secret</b><br>3. Generate <b>Access Token</b> + <b>Access Token Secret</b> (with Read+Write)<br>4. Free tier allows 500 tweets/month',
	      };
	      if (guideEl) {
