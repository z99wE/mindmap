...
router.post('/:id/test', authMiddleware, async (req, res) => {
  try {
    ...
    const testMessage = `[ReMentally Test] This is a test message to your ${channel.platform} channel. If you see this, delivery is working.`;
...
router.post('/digest', authMiddleware, async (req, res) => {
  try {
    ...
    if (pulseKit && typeof pulseKit.send === 'function') {
      ...
      await pulseKit.send({ to: req.user.userId, message, title: 'ReMentally Digest' });
