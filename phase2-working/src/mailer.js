...
const RESEND_SENDER_NAME = process.env.RESEND_SENDER_NAME || 'Unzonk';
...
function waitlistTemplate({ name, plan }) {
  ...
  const bodyText = isUpdates
    ? `Thank you for subscribing to updates and news from <strong style="color:#ccff00;">Unzonk</strong>. We'll keep you in the loop with new features, deep-dives, and updates designed to clear the mental fog.`
    : `We've reserved your spot for <strong style="color:#ccff00;">${planLabel}</strong>. You'll be among the first to experience Unzonk when we open access.`;
    ...
    <tr><td align="center">
      <table width="560" cellpadding="0" cellspacing="0" style="max-width:560px;width:100%;">
        <tr><td style="padding-bottom:32px;text-align:center;">
          ...
          <span style="font:700 18px/40px Inter,system-ui;color:#f0f4ee;letter-spacing:-0.02em;vertical-align:top;margin-left:10px;">Unzonk</span>
        </td></tr>
        <tr><td style="background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:20px;padding:40px 36px;">
          ...
          <p style="margin:0 0 6px;font:400 14px/1.6 Inter;color:rgba(240,244,238,0.7);">&#x2022; Tips for optimizing focus and clearing the mental fog</p>
          ...
          <p style="margin:0 0 24px;font:400 14px/1.6 Inter;color:rgba(240,244,238,0.7);">&#x2022; Your cognitive companion will be ready to clear the mental fog</p>
          `}
          <hr style="border:none;border-top:1px solid rgba(255,255,255,0.08);margin:24px 0;">
          ...
          <a href="https://thought-gps.onrender.com" style="display:inline-block;background:linear-gradient(145deg,#d6ff3e,#ccff00);color:#000;font:700 14px/1 Inter,system-ui;padding:14px 28px;border-radius:100px;text-decoration:none;">Try Unzonk Free &#x2192;</a>
        </td></tr>
        <tr><td style="padding-top:24px;text-align:center;">
          <p style="margin:0;font:400 12px/1.6 Inter;color:rgba(240,244,238,0.3);">Unzonk &#x2014; Clear the Mental fog<br>You're receiving this because you joined the waitlist.</p>
        </td></tr>
      </table>
    </td></tr>
  </table>
...
function welcomeTemplate({ firstName, email }) {
  ...
  return `<!DOCTYPE html>
<html lang="en">
<head><meta charset="UTF-8"><title>Welcome to Unzonk</title></head>
<body style="margin:0;padding:0;background:#080a0f;font-family:'Inter',system-ui,sans-serif;">
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#080a0f;padding:40px 16px;">
    <tr><td align="center">
      <table width="560" cellpadding="0" cellspacing="0" style="max-width:560px;width:100%;">
        <tr><td style="padding-bottom:32px;text-align:center;">
          <span style="display:inline-block;width:40px;height:40px;border-radius:12px;background:linear-gradient(145deg,#d6ff3e,#ccff00);text-align:center;line-height:40px;font:italic 700 20px Inter;color:#000;">U</span>
        </td></tr>
        <tr><td style="background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.10);border-radius:20px;padding:40px 36px;">
          ...
          <p style="margin:0 0 24px;font:400 16px/1.6 Inter;color:rgba(240,244,238,0.7);">Your Unzonk account is ready. Start capturing thoughts and clearing the mental fog.</p>
          <a href="https://thought-gps.onrender.com" style="display:inline-block;background:linear-gradient(145deg,#d6ff3e,#ccff00);color:#000;font:700 14px/1 Inter;padding:14px 28px;border-radius:100px;text-decoration:none;">Open Unzonk &#x2192;</a>
        </td></tr>
        <tr><td style="padding-top:24px;text-align:center;">
          <p style="margin:0;font:400 12px/1.6 Inter;color:rgba(240,244,238,0.3);">Unzonk &#x2014; Clear the Mental fog</p>
        </td></tr>
      </table>
    </td></tr>
  </table>
...
async function sendWaitlistConfirmation({ email, name, plan }) {
  return sendEmail({
    ...
    subject: `You're on the Unzonk waitlist 🧠`,
...
async function sendWelcomeEmail({ email, firstName }) {
  return sendEmail({
    ...
    subject: `Welcome to Unzonk, ${firstName || email.split('@')[0]}!`,
